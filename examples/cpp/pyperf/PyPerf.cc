...
int main(int argc, char** argv) {
  ...
  while (true) {
    ...
    found = found || parseStrArg({"--get-fs-offset"}, getFsOffset);
    if (!found) {
  ...
  try {
    ...
    auto res = profiler.init(symbolsMapSize, eventsBufferPages, kernelStacksMapSize, userStacksPages, getFsOffset);
